...
EXTRA_UNITS = ('API/WebExtensionAPITabs.cpp', 'API/WebExtensionAPIPermissions.cpp', 'API/WebExtensionAPICommands.cpp',
...
BINDING_UNITS = ('JSWebExtensionAPITabs.cpp', 'JSWebExtensionAPIPermissions.cpp', 'JSWebExtensionAPICommands.cpp',
...
UI_API_UNITS = {'WebExtensionTabQueryParser.cpp': 'Shared/Extensions/WebExtensionTabQueryParser.cpp',
