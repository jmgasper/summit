...
cd "$SUMMIT_ROOT"
tar -C .cache/WebKit/Source/WebCore/platform/graphics -cf - ShareableBitmap.h ShareableBitmap.cpp Icon.h |
    bash tools/haiku.sh 'mkdir -p /boot/home/summit/build-bitmap-tests && tar -xf - -C /boot/home/summit/build-bitmap-tests'
tar -C .cache/WebKit/Source/WebCore/platform/graphics/haiku -cf - ShareableBitmapHaiku.cpp GraphicsContextHaiku.cpp IconHaiku.cpp |
    bash tools/haiku.sh 'tar -xf - -C /boot/home/summit/build-bitmap-tests'
tar -C .cache/WebKit/Source/WebKit/Platform/haiku -cf - BitmapFrameHaiku.h BitmapPresenterHaiku.h |
    bash tools/haiku.sh 'tar -xf - -C /boot/home/summit/build-bitmap-tests'
