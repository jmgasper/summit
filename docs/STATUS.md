...
- **23 native browser checks pass in the installed package**: native scripting responsiveness, a real
...
`browser-smoke.log`, `package-smoke.log`, `session-restart.log`, `http.log`,
