...
separate profiles. The launcher enables Skia GL Canvas by default after the
raster-scrollbar and Guardian playback checks. Set
`SUMMIT_SKIA_GL_CONTEXT=0` when launching it to compare CPU Canvas rendering.
